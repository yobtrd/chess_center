class Match:
    ...
    def __init__(self, player1, player2):
        """Initializes all the data needed for the match."""
    ...
    def add_match_result(self, point_p1, points_p2):
        ...
        self.match_result = ([self.player1, point_p1], [self.player2, points_p2])
        return self.match_result

    def to_dict(self):
        """Transform a Match model to a match's dictionnary datas."""
        result = {"player1": self.player1.to_dict(), "player2": self.player2.to_dict()}
